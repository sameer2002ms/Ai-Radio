...
class MyRadioList{
  ...
  factory MyRadioList.fromMap(Map<String, dynamic> map){
    ...
    return MyRadioList(
      radios: List<MyRadio>.from(map['radio'] ?.map((e) => MyRadio.fromMap(e))),
    );
  }
...
class MyRadio {
  ...
  MyRadio({required this.id, required this.order, required this.name, required this.tagline, required this.color, required this.desc,
      required this.url, required this.category, required this.icon, required this.image, required this.lang});
